...
<body data-type="index">
		...
		<div class="tpl-left-nav tpl-left-nav-hover">
			...
			<div class="tpl-left-nav-list">
				<ul class="tpl-left-nav-menu">
					<li class="tpl-left-nav-item"><a href="indextest.jsp"
						class="nav-link active" target="mainframe"> <i
					...
					<li class="tpl-left-nav-item"><a href="javascript:;"
						class="nav-link tpl-left-nav-link-list"> <i
							class="am-icon-table"></i> <span>歌曲</span> <i
							class="am-icon-angle-right tpl-left-nav-more-ico am-fr am-margin-right"></i>
					</a>
						<ul class="tpl-left-nav-sub-menu">
							<li><a href="song_list.jsp" target="mainframe"> <i
									class="am-icon-angle-right"></i> <span>所有歌曲</span> <i
									class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
							</a> <a href="song_upload.jsp" target="mainframe"> <i
									class="am-icon-angle-right"></i> <span>上传歌曲</span> <i
									class="tpl-left-nav-content tpl-badge-success"> 18 </i></a> <a
								href="form-news.html"> <i class="am-icon-angle-right"></i> <span>消息列表</span>
									<i class="tpl-left-nav-content tpl-badge-primary"> 5 </i></a> <a
					...
					<li class="tpl-left-nav-item"><a href="javascript:;"
						...
						<ul class="tpl-left-nav-sub-menu" style="display: block;">
							<li><a href="user_list.jsp?#" target="mainframe"> <i
									class="am-icon-angle-right"></i> <span>所有用户</span> <i
									class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
	...
	<!-- main右下角分页 -->
	<iframe align="right" name="mainframe" width="82%" height="80%"
		scrolling="no" src="indextest.jsp" frameborder="0"
