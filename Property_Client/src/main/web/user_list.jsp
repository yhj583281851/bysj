					...
					<form>
						...
						<div class="form-group">
							<label for="exampleInputPassword1">年龄</label> <input type="text"
								class="form-control" id="update_user_age" name="userAge"
								placeholder="请输入年龄"> <span class="help-block"></span>
						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">地址</label> <input type="text"
								class="form-control" id="update_user_address" name="userAddress"
								placeholder="请输入个人介绍地址"> <span class="help-block"></span>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="exampleInputPassword1">类型（0-管理员，1-住户，2-游客）</label> <input type="text"
                                ...
                                <table id="user_table" class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-title">类型（0-管理员<br>1-住户，2-游客）</th>
                                            <th class="table-set">跳转</th>
