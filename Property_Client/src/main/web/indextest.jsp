        ...
        <div>
            ...
            <div class="tpl-content-scope">
                <div class="note note-info">
                    ...
                    <p> 优秀的业务管理平台</p>
                    <p><span class="label label-danger">提示:</span> 本页面开发中。。。。
                    </p>
                </div>
            </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <a class="user-name" href="###">高梨康治</a>
                                        </td>
                                        <td>213</td>
                                        <td>6225</td>
                                        <td class="font-green bold">56%</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <img src="assets/img/user02.png" alt="" class="user-pic">
                                            <a class="user-name" href="###">雪桜草</a>
                                        </td>
                                        <td>135</td>
                                        <td>5232</td>
                                        <td class="font-green bold">44%</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <img src="assets/img/user03.png" alt="" class="user-pic">
                                            <a class="user-name" href="###">riya</a>
                                        </td>
                                        <td>167</td>
                                        <td>4465</td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a class="user-name" href="###">马飞</a>
                                        </td>
                                        <td>57</td>
                                        <td>3265</td>
                                        <td class="font-green bold">23%</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <img src="assets/img/user05.png" alt="" class="user-pic">
                                            <a class="user-name" href="###">増田俊郎</a>
                                        </td>
                                        <td>107</td>
                                        <td>3265</td>
                                        <td class="font-green bold">23%</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>90</td>
                                        <td>265</td>
                                        <td class="font-green bold">20%</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
