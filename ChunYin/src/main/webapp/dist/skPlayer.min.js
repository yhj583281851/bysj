...
!function(t, e) {
    ...
    return function(t) {
        ...
        console.log("%cSKPlayer 3.0.8", "color:#4cb6cb"),
        n(1);
        var s = {
          ...
          , l = function() {
            function t(e) {
                ...
                this.init(),
                this.bind()) : "cloud" === this.type && (this.root.innerHTML = '<p class="skPlayer-tip-loading">LOADING</p>',
                s.ajax({
            ...
            return r(t, [{
                ...
                value: function() {
                    ...
                    for (var e in this.music)
                        ...
                        '                  <span class="skPlayer-list-name" title="' + this.music[e].name + '">' + this.music[e].name + 
                        '</span>\n                    <button class="skPlayer-list-author btn btn-link" onclick="player.deleteSong('+e+')"><span class="glyphicon glyphicon-trash" aria-hidden="true" ></span></button>' + 
                        '</span>\n                    <span class="skPlayer-list-author" title="' + this.music[e].author + '">' + this.music[e].author + 
                        "\n              </li>\n            ";
                    return t += "\n            </ul>\n        "
                }
            }, {
                ...
                value: function() {
                    ...
                    this.dom.timeline_total.addEventListener("click", function(e) {
                        ...
                        isNaN(t.audio.duration) || (t.dom.timeline_played.style.width = s.percentFormat(o),
                        t.dom.timetext_played.innerHTML = s.timeFormat(o * t.audio.duration),
                        t.audio.currentTime = o * t.audio.duration)
                    }),
                ...
                value: function(t) {
                    var e = this;
                    return "number" != typeof t ? void console.error("请输入正确的歌曲序号！") : (t -= 1) < 0 || t >= this.music.length ? void console.error("请输入正确的歌曲序号！") : t == this.dom.musiclist.querySelector(".skPlayer-curMusic").getAttribute("data-index") ? void this.play() : (this.dom.musiclist.querySelector(".skPlayer-curMusic").classList.remove("skPlayer-curMusic"),
                    ...
                    void ("file" === this.type ? (this.audio.src = this.music[t].src,
                    this.play()) : "cloud" === this.type && s.ajax({
                        ...
                        success: function(t) {
                            ...
                            null !== n ? (console.log("歌曲拉取成功！"),
                            e.audio.src = n,
                            e.play()) : (console.log("歌曲拉取失败！ 资源无效！"),
            	...
            	value:function(t){
            		var list = this.music;
            		 ...
            		 this.music = list;
            		 var musicList = $(".skPlayer-list");
            		 var my = musicList.find("li:eq("+(t-1)+")");
            		 if (my != null)
            			 {
                ...
                value: function() {
                    ...
                    this.dom.volumeline_value.style.width = s.percentFormat(this.audio.volume)) : (this.audio.muted = !0,
