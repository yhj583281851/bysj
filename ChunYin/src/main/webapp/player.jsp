...
<!-- 			<button class="mp-lrc-toggle" title="评论"></button> -->
		</div>
	</div>
...
//播放音乐
function play(data){
	var song_name = data.data.song.songName;
	var composerName = data.data.song.composerName;
	var song_url = data.data.song.songUrl;
	var song_time = data.data.song.songTime;
	var song_img = data.data.song.songImageUrl;
...
function play2(songs){
	
	for(var j = 0;j<songs.length;j++){
		player.addSong(songs[j]);
	}
